...
(function () {
    ...
    var PROJ = {
        ...
        fill10: {
            title: 'eficiente visual-big', img: '../img/projects/efivibigbig.webp', icons: [
        ...
        fill11: {
            title: 'rivota-big', img: '../img/projects/rivotabigbig.webp', icons: [
                { img: '../img/close-icon.svg', action: 'close', label: 'Fechar' },
            ]
        },
        fill12: {
            title: 'stargaze-big', img: '../img/projects/iaplatbigbig.webp', icons: [
                { img: '../img/close-icon.svg', action: 'close', label: 'Fechar' },
            ]
        },
        fill13: {
            title: 'rações do pedrão-big', img: '../img/projects/racaobigbig.webp', icons: [
                { img: '../img/close-icon.svg', action: 'close', label: 'Fechar' },
            ]
        },
        fill14: {
            title: 'night march-big', img: '../img/projects/night-marchbigbig.webp', icons: [
                { img: '../img/close-icon.svg', action: 'close', label: 'Fechar' },
        ...
        fill15: {
            title: 'filhos de pelo-big', img: '../img/projects/projongbigbig.webp', icons: [
                { img: '../img/close-icon.svg', action: 'close', label: 'Fechar' },
                { img: '../img/web-icon.svg', href: 'https://www.filhosdepelo.com/', label: 'Website' },
            ]
        },
        fill16: {
            title: 'sonho gelado-big', img: '../img/projects/sonhogbigbig.webp', icons: [
                { img: '../img/close-icon.svg', action: 'close', label: 'Fechar' },
            ]
        },
    };
    ...
    function openModal(item) {
        ...
        var langImgMap = window.PROJECT_IMG_MAP && window.PROJECT_IMG_MAP[lang];
        var openImg = (bigId && langImgMap && langImgMap[bigId]) || (bigData ? bigData.img : data.img);
